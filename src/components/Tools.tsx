...
export default function Tools() {
  ...
  return (
    <section id="tools" className="py-24 px-6 relative bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tools.map((tool, i) => (
            <motion.div
              ...
              className="bg-cream p-6 rounded-3xl border border-navy/5 hover:border-electric/30 transition-all duration-300 group hover:-translate-y-1 hover:shadow-lg hover:shadow-navy/5 flex flex-col h-full"
            >

...
content = content.replace(/className=\{\`absolute -left-\\[17px\\] top-1 w-8 h-8 rounded-full bg-white border-4 \$\\{sem.color flex items-center justify-center shadow-sm\`>/g, 'className={`absolute -left-[17px] top-1 w-8 h-8 rounded-full bg-white border-4 ${sem.color} flex items-center justify-center shadow-sm`}>');
